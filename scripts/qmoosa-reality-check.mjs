...
if (existsSync("testnet/genesis.json") && existsSync("testnet/network-manifest.example.json")) {
  ...
  const allowedStatus = manifest.status === "NOT_VERIFIED" || manifest.status === "DRAFT_NOT_LAUNCHED" || manifest.status === "PUBLIC_TESTNET_LIVE_TUNNEL" || manifest.status === "PUBLIC_TESTNET_VERIFIED" || manifest.status === "PUBLIC_TESTNET_CANDIDATE";
